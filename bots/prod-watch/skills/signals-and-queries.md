...
| `card` | 15–19 digits with separators, **Luhn-validated** | `[REDACTED:card]` |
...
timestamp is not an IBAN, a 13-digit epoch is not a card), they do not
make it a proof. This slice reports every class at severity `high`; the
