...
def seal_committed_opted_in(gm_dir):
    ...
    try:
        with open(os.path.join(gm_dir, "config.json"), encoding="utf-8") as f:
            return json.load(f).get("seal_committed") is True
