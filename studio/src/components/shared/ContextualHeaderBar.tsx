...
// Slim header bar above <main>. Always present so the account menu stays pinned
// top-right (the standard spot); a page's optional left/right content (pushed
// via useHeaderSlot) sits alongside. In local dev the account chip self-hides.
