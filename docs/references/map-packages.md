...
239 packages, excluding vendored and generated trees. The third column lists exported **interfaces** — the seams a new variant plugs into rather than branching the core.
...
| `pkg/treenoise` | the canonical list of "tree noise": paths the run's own setup and tooling write into the workspace, which never count as the pass's work — the… | — | 1 · 9 |
