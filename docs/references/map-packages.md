...
251 packages, excluding vendored and generated trees. The third column lists exported **interfaces** — the seams a new variant plugs into rather than branching the core.
