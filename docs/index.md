...
features:
  ...
  - icon: 🤝
    ...
    details: Mix providers and backends per node — a plan from one model reviewed by another. Claude Code, in-process claw, Codex, `pi`, Kimi, and Grok, with credential auto-detection.
    link: /backends
