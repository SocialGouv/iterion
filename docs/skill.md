...
| [`references/diagnostics.md`](references/diagnostics.md) | Authoritative sparse catalogue of DSL diagnostics (C001–C199 plus C240–C248) and bundle checks (C200–C234), with causes and fixes |
