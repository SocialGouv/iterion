...
| [`references/diagnostics.md`](references/diagnostics.md) | Authoritative sparse catalogue of DSL diagnostics (C001–C199 plus the async/parallel/fail band C240–C249 and the connector-`action:` band C260–C268) and bundle checks (C200–C234 and C250–C253), with causes and fixes |
