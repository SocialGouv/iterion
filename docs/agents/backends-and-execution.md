...
`codeindex` (deterministic repo-indexing MCP — link graph, symbols,
callers, indexed search, hotspots, symbolic edits), `graphify`,
`repo-falcon` and `firecrawl` (web search/scrape MCP —
