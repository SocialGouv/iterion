...
and, at any status, the mirror's own bookkeeping: .claude/.iterion-managed/
and an .iterion-managed/ directly inside each of those three directories. A tracked file's change under those directories
