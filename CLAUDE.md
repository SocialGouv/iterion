...
iterion fix <file.bot|dir> [--dry-run]   # Apply the mechanical remedies of diagnostics (C137)
...
| "Where is…", "what else uses…", "what breaks if I change…" — before grepping a 3 798-Go-file tree | [repo-map-and-graph.md](docs/repo-map-and-graph.md) |
