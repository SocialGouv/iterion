...
// DecodePublicJSON accepts one JSON value, preserving numbers (json.Number)
// and rejecting duplicate object members and trailing values. The editor
// JSON and the .bot text must never assign two meanings to the same public
// default or criterion parameters.
