...
var ebnfProductions = map[string]string{
	"contract":           "contract_prop",
	"contract.port":      "contract_port_prop",
	"contract.file":      "contract_file_prop",
	"contract.criterion": "contract_criterion_prop",
	"contract.effect":    "contract_effect_prop",
	"port_policy":        "port_policy_prop",
	"port_policy.effect": "port_effect_policy_prop",
	"graph":              "port_graph_prop",
	"graph.node":         "port_node_prop",
	"agent":              "llm_prop",
	"judge":              "llm_prop",
	"router":             "router_prop",
	"human":              "human_prop",
